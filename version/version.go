...
// go build -v -ldflags "-X github.com/Decred-Next/dcrndata/v8/v5/version.appPreRelease= -X github.com/Decred-Next/dcrndata/v8/v5/version.appBuild=`git rev-parse --short HEAD`"
var (
