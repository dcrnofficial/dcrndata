...
function makeMempoolBlock (block) {
  ...
  return makeNode(`<div class="block visible">
                <div class="block-info">
                    ...
                    <div class="mono" style="line-height: 1;">${Math.floor(block.Total)} DCRN</div>
                    <span class="timespan">
...
function makeBlockSummary (blockHeight, totalSent, time) {
  return `<div class="block-info">
                ...
                <div class="mono" style="line-height: 1;">${Math.floor(totalSent)} DCRN</div>
                <span class="timespan">
    ...
    this.tooltipTargets.forEach((tooltipElement) => {
      try {
        ...
        if (data.object === 'Vote') {
          ...
          newContent = `<b>${data.object}</b><br>${data.total} DCRN`
        }
