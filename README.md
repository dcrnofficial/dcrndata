...
[![Build Status](https://github.com/DCRN/dcrndata/workflows/Build%20and%20Test/badge.svg)](https://github.com/DCRN/dcrndata/actions)
[![Latest tag](https://img.shields.io/github/tag/decred/dcrdata.svg)](https://github.com/DCRN/dcrndata/tags)
[![Go Report Card](https://goreportcard.com/badge/github.com/DCRN/dcrndata)](https://goreportcard.com/report/github.com/DCRN/dcrndata)
...
| Legacy      | 5.2     | `5.2-stable`  | `v5.2.2`           | ^6.1.1 (dcrd v1.6.0-pre@[`7b060207`](https://github.com/DCRN/dcrnd/commit/7b060207b19595ef8cc7ae4ee120c66af623239a) to `HEAD`) |
...
- Clone the dcrdata repository. It is conventional to put it under `GOPATH`, but
  ...
  ```sh
  git clone https://github.com/DCRN/dcrndata $HOME/go-work/github/decred/dcrdata
  ```
...
GO111MODULE=on go build -o dcrdata -v -ldflags \
    "-X github.com/DCRN/dcrndata/v5/version.appPreRelease=beta \
     -X github.com/DCRN/dcrndata/v5/version.appBuild=`git rev-parse --short HEAD`"
```
...
While dcrdata now provides [support for CockroachDB](https://github.com/DCRN/dcrndata/issues/1291),
this is an experimental feature with caveats:

- Compared to a well-configure PostgreSQL backend, CoackroachDB performance is
  suboptimal. See the [CockroachDB issue](https://github.com/DCRN/dcrndata/issues/1291)
...
See [dcrdata's CockroachDB wiki page](https://github.com/DCRN/dcrndata/wiki/CockroachDB)
for more information.
...
`github.com/DCRN/dcrnd/database` with an ffldb storage backend from
`github.com/DCRN/dcrnd/database/ffldb`. It also makes use of the `stake.Node`
type from `github.com/DCRN/dcrnd/blockchain/stake`. The `ChainMonitor` type
...
See the GitHub [issue trackers](https://github.com/DCRN/dcrndata/issues) and
the [project milestones](https://github.com/DCRN/dcrndata/milestones).
...
5. Create a [pull request](https://github.com/DCRN/dcrndata/compare).
