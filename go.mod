...
require (
	...
	github.com/Decred-Next/dcrndata/db/dcrpg/v8 v8.0.10
	github.com/Decred-Next/dcrndata/exchanges/v8 v8.0.10
	github.com/Decred-Next/dcrndata/explorer/types/v8 v8.0.10
	github.com/Decred-Next/dcrndata/gov/v8 v8.0.10
	github.com/Decred-Next/dcrndata/mempool/v8 v8.0.10
	github.com/Decred-Next/dcrndata/middleware/v8 v8.0.10
	github.com/Decred-Next/dcrndata/pubsub/types/v8 v8.0.10
	github.com/Decred-Next/dcrndata/pubsub/v8 v8.0.10
