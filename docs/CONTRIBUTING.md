...
1. Fork the repository on GitHub.  Just click the little Fork button at https://github.com/dcrnofficial/dcrndata
...
```sh
git remote add upstream https://github.com/dcrnofficial/dcrndata.git
git fetch upstream
...
[Code Contribution Guidelines](https://github.com/dcrnofficial/dcrnd/blob/master/docs/code_contribution_guidelines.md).
...
[Code Contribution Guidelines](https://github.com/dcrnofficial/dcrnd/blob/master/docs/code_contribution_guidelines.md) (dcrd repo)