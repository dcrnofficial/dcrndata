...
1. Fork the repository on GitHub.  Just click the little Fork button at https://github.com/DCRN/dcrndata
...
```sh
git remote add upstream https://github.com/DCRN/dcrndata.git
git fetch upstream
...
[Code Contribution Guidelines](https://github.com/DCRN/dcrnd/blob/master/docs/code_contribution_guidelines.md).
...
[Code Contribution Guidelines](https://github.com/DCRN/dcrnd/blob/master/docs/code_contribution_guidelines.md) (dcrd repo)