...
- `docker run --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/dcrnofficial/dcrndata --rm decred/dcrdata:dev-alpine go build`
...
`docker run -e GOOS=darwin -e GOARCH=amd64 --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/dcrnofficial/dcrndata --rm decred/dcrdata:dev-alpine go build`

`docker run -e GOOS=windows -e GOARCH=amd64 --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/dcrnofficial/dcrndata --rm decred/dcrdata:dev-alpine go build`
...
`docker run -ti --entrypoint="" -v ${PWD}:/home/decred/go/src/github.com/dcrnofficial/dcrndata --rm decred/dcrdata:dev-alpine /bin/bash`
...
`docker run -ti --entrypoint=/bin/bash -e DCRDATA_LISTEN_URL=0.0.0.0:2222 -v ${PWD}:/home/decred/go/src/github.com/dcrnofficial/dcrndata --rm decred/dcrdata:dev-alpine`
